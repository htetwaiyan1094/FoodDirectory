<?php
  ...
  $logoname = "images/stores/$fsid.jpg";
    ...
    (store_id, store_name, logo, typeid, pricerng, phno, address, reg_date, location, cus_id )
    VALUES('$fsid', '$fsname', '$logoname','$fstype','$prng','$phno','$address', now(),'$l','$cusid' )";
  } else {
    $sql = "INSERT INTO food_store
    (store_id, store_name, logo, typeid, pricerng, phno, address, reg_date, location, cus_id )
    VALUES('$fsid', '$fsname', 'nologo','$fstype','$prng','$phno','$address', now(),'$l','$cusid' )";
  }
  
  mysql_query($sql) or die(mysql_error());
  
  echo "<script>alert('Successfully Added!!');</script>";
  echo "<script>window.location='storeadd.php';</script>";
?>